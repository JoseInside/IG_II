...
//NORIA variables
GLfloat angRot, numVagon, giroNoria;
...
void aspaNoria(){
	...
	glRotatef(angRot + giroNoria, 0.0f, 0.0f, 1.0f);
	...
	glRotatef(angRot + giroNoria, 0.0f, 0.0f, 1.0f);
	glScalef(0.5f, 5.5f, 0.1f);
	glTranslatef(0.0f, -0.4f, 5.0f);
	glutSolidCube(1);
	glPopMatrix();
...
void noria(){
	...
	glPushMatrix();
	glColor3f(0.6f, 0.4f, 0.2f);
	glRotatef(angRot, 0.0f, 0.0f, 1.0f);
	glScalef(0.5f, 5.5f, 0.1f);
	glTranslatef(0.0f, -0.4f, -5.0f);
	glutSolidCube(1);
	glPopMatrix();*/
...
void key(unsigned char key, int x, int y){
	...
	switch (key) {
		...
		case '7': angRot += 5; break;
		case '8': giroNoria += 5; break;
		default:
